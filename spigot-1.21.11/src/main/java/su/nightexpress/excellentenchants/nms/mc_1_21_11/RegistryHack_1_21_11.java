...
public class RegistryHack_1_21_11 implements RegistryHack {
    ...
    public void createItemsSet(ItemSet itemSet) {
        ...
        itemSet.getMaterials().forEach(material -> {
            Identifier location = Identifier.withDefaultNamespace(material);// CraftNamespacedKey.toMinecraft(material.getKey());

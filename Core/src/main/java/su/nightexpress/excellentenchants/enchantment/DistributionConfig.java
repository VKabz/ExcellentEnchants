...
public class DistributionConfig extends AbstractConfig implements DistributionSettings {
    ...
    public static DistributionConfig load(Path dataDir) {
    ...
    private final ConfigProperty<Boolean> useMinecraftNamespace = this.addProperty(ConfigTypes.BOOLEAN,
        "Core.Use-Minecraft-Namespace",
        false,
    ...
    private final ConfigProperty<Boolean> distributionEnchanting = this.addProperty(ConfigTypes.BOOLEAN,
        "Distribution.Enchanting_Table",
        true,
    ...
    private final ConfigProperty<Boolean> distributionTrading = this.addProperty(ConfigTypes.BOOLEAN,
    ...
    private final ConfigProperty<Boolean> distributionMobEquipment = this.addProperty(ConfigTypes.BOOLEAN,
        "Distribution.Mob_Equipment",
        true,
    ...
    private final ConfigProperty<Boolean> distributionTradeEquipment = this.addProperty(ConfigTypes.BOOLEAN,
        "Distribution.Trade_Equipment",
        true,
    ...
    private final ConfigProperty<Boolean> distributionRandomLoot = this.addProperty(ConfigTypes.BOOLEAN,
        "Distribution.Random_Loot",
        true,

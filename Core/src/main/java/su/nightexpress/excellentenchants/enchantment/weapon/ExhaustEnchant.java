...
public class ExhaustEnchant extends GameEnchantment implements AttackEnchant {
    ...
    public ExhaustEnchant(EnchantsPlugin plugin, EnchantManager manager, Path file, EnchantContext context) {
        super(plugin, manager, file, context);
        this.addComponent(EnchantComponent.PROBABILITY, Probability.addictive(0, 5));
        this.addComponent(EnchantComponent.POTION_EFFECT, PotionEffects.temporal(PotionEffectType.HUNGER, Modifier
            .addictive(10).perLevel(5).capacity(60)));
    }

...
@NullMarked
public class ColdSteelEnchant extends GameEnchantment implements DefendEnchant {

    public ColdSteelEnchant(EnchantsPlugin plugin, EnchantManager manager, Path file, EnchantContext context) {

...
@NullMarked
public class WitherEnchant extends GameEnchantment implements AttackEnchant {

    public WitherEnchant(EnchantsPlugin plugin, EnchantManager manager, Path file, EnchantContext context) {
        super(plugin, manager, file, context);
        this.addComponent(EnchantComponent.PROBABILITY, Probability.addictive(4, 3));
        this.addComponent(EnchantComponent.POTION_EFFECT, PotionEffects.temporal(PotionEffectType.WITHER, Modifier
            .addictive(4).perLevel(2).capacity(10)));
    }

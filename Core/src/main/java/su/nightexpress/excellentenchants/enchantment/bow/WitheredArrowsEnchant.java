...
@NullMarked
public class WitheredArrowsEnchant extends GameEnchantment implements BowEnchant {

    public WitheredArrowsEnchant(EnchantsPlugin plugin, EnchantManager manager, Path file, EnchantContext context) {

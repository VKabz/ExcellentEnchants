...
public class HoverEnchant extends GameEnchantment implements BowEnchant {
    ...
    public HoverEnchant(EnchantsPlugin plugin, EnchantManager manager, Path file, EnchantContext context) {
        ...
        this.addComponent(EnchantComponent.POTION_EFFECT, PotionEffects.temporal(PotionEffectType.LEVITATION, Modifier
            .addictive(4).perLevel(1).capacity(10)));
    }
